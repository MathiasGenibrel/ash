...
mod tests {
    ...
    use crate::features::pty::fakes::{
        located_registry, observed_registry, pausable_registry, recognizing_registry, registry,
        spec, supervised_registry, CountingLocator, FakeAgentStates, FakeSpawner, SpecBuilder,
        LAUNCHED,
    };
    use std::os::fd::RawFd;
